...
int main()
{
	...
	pointLights[0] = PointLight(1.0f, 1.0f, 1.0f,  // Blanco
		0.3f, 0.9f,
		6.0f, 2.2f, 6.0f,
		0.3f, 0.2f, 0.1);
	pointLightCount++;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(mainWindow.getarticulacion1() / 50, 5.0f, 6.0));
		...
		spotLights[1].SetFlash(
			glm::vec3((mainWindow.getarticulacion1() / 50) - 1.0f, 4.75f, 6.0f),
