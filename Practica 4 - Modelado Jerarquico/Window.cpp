...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_B)
	{
		theWindow->articulacionB += 10.0;
	}
	if (key == GLFW_KEY_N)
	{
		theWindow->articulacionN += 10.0;
	}
	if (key == GLFW_KEY_M)
	{
		theWindow->articulacionM += 10.0;
	}
	if (key == GLFW_KEY_U)
	{
		theWindow->articulacionU += 10.0;
	}
	if (key == GLFW_KEY_I)
	{
		theWindow->articulacionI += 10.0;
	}
	if (key == GLFW_KEY_O)
	{
		theWindow->articulacionO += 10.0;
	}
	if (key == GLFW_KEY_P)
	{
		theWindow->articulacionP += 10.0;
	}
